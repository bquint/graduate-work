...
{
    public partial class AddQuestShip : Form
    {
        string id;
        public AddQuestShip(string UserId)
        {
            InitializeComponent();
            id = UserId;
            DB db = new DB();
        ...
        private void AddQuestShip_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command1 = new MySqlCommand("SELECT id FROM `TypeOfShip` WHERE `typeofship` = @identic ", db.GetConnection());
            ...
            MySqlCommand command3 = new MySqlCommand("INSERT INTO `QuestionsTypeOfShip` (`id_typeofship`, `id_picture`, `Text_question`, `trueanswer`, `var_1`,`var_2`,`var_3`) VALUES (@str1, @str2, @str3, @str4, @str5, @str6, @str7 )", db.GetConnection());
