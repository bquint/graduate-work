...
{
    public partial class Bilet2 : Form
    {
        string id;
        string tpofdistrict;
        string tpofship;
        ...
        int ostatok = 10;
        int ostatok1;
        public Bilet2(string UserId, string UserTd, string UserSh, int Points, int Ostatok)
        {
           /* InitializeComponent();
           ...
           /*
            ...
            adapter3.Dispose();
            label13.Text = points1.ToString();
            label14.Text = ostatok1.ToString();*/
        ...
        {
            this.Hide();
            Bilet1 bilet1 = new Bilet1(id, tpofdistrict, tpofship);
            bilet1.Show();
        }
        ...
        {/*
            ...
            label15.Text = ostatok.ToString();
            this.Hide();
            PostTest post = new PostTest(id, tpofdistrict, tpofship, points1, ostatok, point, ostatok1);
            post.Show();*/
        }
        ...
        private void Bilet2_Load(object sender, EventArgs e)
        {
